...
function initVertexBuffersForTriangle(gl) {
  ...
  // Vertex coordinates
  var vertices = new Float32Array([ -0.5, -0.5,  0.5,   -0.5,  0.5,  0.5,   0.5,  0.7,  0.5,   0.5, -0.5,  0.5,   -0.5, -0.5, -0.5,   -0.8, -0.5, -0.5,   -0.7,  0.5, -0.5,   0.5, 0.5, -0.5,   0.5, 0.5, -0.7,   0.5, 0.7, -0.5,   0.5,-0.5, -0.5]);


  // Colors
  var colors = new Float32Array([1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,   1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,   1.0, 0.5, 0.0,  1.0, 0.5, 1.0, 0.2, .5, .1,  1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,  1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,   1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,  1.0, 0.5, 0.0,  1.0, 0.5, 1.0, 0.2, .5, .2,  1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,  1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1,  1.0, 0.5, 0.0,  1.0, 0.5, 0.0, 0.2, .5, .1    ]);    
  // Indices of the vertices
  var indices = new Uint8Array([0, 1, 2,  0, 2, 3, 2, 3, 7, 2, 7, 6, 3, 0, 4, 3, 4, 7, 6, 5, 1, 6, 1, 2, 4, 5, 6, 4, 6, 7, 5, 4, 0, 5, 0, 1]);
